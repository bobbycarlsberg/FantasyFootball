...
namespace FantasyFootball.Ranking.MatchDetailsPredictors
{
    public interface IMatchDetailPredictor
    {
        ...
        void SetPoints(RankController rankController, TeamRank teamRank, List<MatchDetailForm> teamMatchDetailForms, PlayerRank playerRank, List<MatchDetailForm> playerMatchDetailForms);
    }
}
